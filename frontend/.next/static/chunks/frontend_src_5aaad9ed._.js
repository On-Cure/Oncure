...
const posts = {
    getPosts: async function() {
        ...
        const data = await fetchAPI("/api/posts?page=".concat(page, "&limit=").concat(limit));
    ...
    getLikedPosts: async function() {
        let page = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 1, limit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 10;
        const data = await fetchAPI("/api/posts/liked?page=".concat(page, "&limit=").concat(limit));
        // Normalize response: if backend returns array directly, wrap it in an object
        if (Array.isArray(data)) {
            return {
                posts: data,
    ...
    getCommentedPosts: async function() {
        let page = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 1, limit = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 10;
        const data = await fetchAPI("/api/posts/commented?page=".concat(page, "&limit=").concat(limit));
        // Normalize response: if backend returns array directly, wrap it in an object
        if (Array.isArray(data)) {
            return {
                posts: data,
    ...
    getReactions: (postId)=>fetchAPI("/api/posts/".concat(postId, "/reactions")),
    addReaction: (postId, reactionType)=>fetchAPI("/api/posts/".concat(postId, "/reactions"), {
            method: "POST",
            body: JSON.stringify({
...
const comments = {
    getPostComments: async function(postId) {
        let page = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, limit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 20, parentId = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : null;
        let url = "/api/posts/".concat(postId, "/comments?page=").concat(page, "&limit=").concat(limit);
        if (parentId) {
            url += "&parentId=".concat(parentId);
        }
    ...
    createComment: (postId, commentData)=>fetchAPI("/api/posts/".concat(postId, "/comments"), {
            method: "POST",
            body: JSON.stringify(commentData)
        }),
    updateComment: (commentId, commentData)=>fetchAPI("/api/comments/".concat(commentId), {
            method: "PUT",
            body: JSON.stringify(commentData)
        }),
    deleteComment: (commentId)=>fetchAPI("/api/comments/".concat(commentId), {
            method: "DELETE"
        }),
    getReactions: (commentId)=>fetchAPI("/api/comments/".concat(commentId, "/reactions")),
    addReaction: (commentId, reactionType)=>fetchAPI("/api/comments/".concat(commentId, "/reactions"), {
            method: "POST",
            body: JSON.stringify({
                reaction_type: reactionType
            })
...
const groups = {
    ...
    getGroup: (groupId)=>fetchAPI("/api/groups/".concat(groupId)),
    updateGroup: (groupId, groupData)=>fetchAPI("/api/groups/".concat(groupId), {
            method: "PUT",
            body: JSON.stringify(groupData)
        }),
    deleteGroup: (groupId)=>fetchAPI("/api/groups/".concat(groupId), {
            method: "DELETE"
        }),
    joinGroup: function(groupId) {
        let invitedBy = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : null;
        return fetchAPI("/api/groups/".concat(groupId, "/join"), {
            method: "POST",
            body: JSON.stringify({
    ...
    leaveGroup: (groupId)=>fetchAPI("/api/groups/".concat(groupId, "/join"), {
            method: "DELETE"
        }),
    inviteToGroup: (groupId, userId)=>fetchAPI("/api/groups/".concat(groupId, "/invite"), {
            method: "POST",
            body: JSON.stringify({
                user_id: userId
            })
        }),
    updateMember: (groupId, userId, status)=>fetchAPI("/api/groups/".concat(groupId, "/members/").concat(userId), {
            method: "PUT",
            body: JSON.stringify({
                status
            })
        }),
    removeMember: (groupId, userId)=>fetchAPI("/api/groups/".concat(groupId, "/members/").concat(userId), {
            method: "DELETE"
        }),
    getPosts: async function(groupId) {
        let page = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, limit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 10;
        const data = await fetchAPI("/api/groups/".concat(groupId, "/posts?page=").concat(page, "&limit=").concat(limit));
    ...
    createPost: (groupId, postData)=>fetchAPI("/api/groups/".concat(groupId, "/posts"), {
            method: "POST",
            body: JSON.stringify(postData)
        }),
    getEvents: (groupId)=>fetchAPI("/api/groups/".concat(groupId, "/events")),
    createEvent: (groupId, eventData)=>fetchAPI("/api/groups/".concat(groupId, "/events"), {
            method: "POST",
            body: JSON.stringify(eventData)
        }),
    respondToEvent: (eventId, response)=>fetchAPI("/api/groups/events/".concat(eventId, "/respond"), {
            method: "POST",
            body: JSON.stringify({
                response
            })
...
const users = {
    ...
    // Profile API methods
    getProfile: function() {
        let userId = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        const endpoint = userId ? "/api/users/".concat(userId, "/profile") : "/api/users/profile";
    ...
    getFollowers: function() {
        let userID = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        const endpoint = userID ? "/api/users/".concat(userID, "/followers") : "/api/users/followers";
        return fetchAPI(endpoint);
    },
    getFollowing: function() {
        let userID = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        const endpoint = userID ? "/api/users/".concat(userID, "/following") : "/api/users/following";
        return fetchAPI(endpoint);
    },
    getFollowCounts: function() {
        let userID = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null;
        const endpoint = userID ? "/api/users/".concat(userID, "/counts") : "/api/users/counts";
        return fetchAPI(endpoint);
    },
    getFollowStatus: (userID)=>fetchAPI("/api/users/".concat(userID, "/follow-status")),
    followUser: (userID)=>fetchAPI("/api/users/".concat(userID, "/follow"), {
            method: "POST"
        }),
    unfollowUser: (userID)=>fetchAPI("/api/users/".concat(userID, "/follow"), {
            method: "DELETE"
        }),
    cancelFollowRequest: (userID)=>fetchAPI("/api/users/".concat(userID, "/follow-request"), {
            method: "DELETE"
        }),
    acceptFollowRequest: (userID)=>fetchAPI("/api/users/".concat(userID, "/accept-follow"), {
            method: "POST"
        }),
    getSuggestedUsers: ()=>fetchAPI("/api/users/suggested"),
    getOnlineUsers: ()=>fetchAPI("/api/users/online"),
    getAllUsers: ()=>fetchAPI("/api/users/all"),
    acceptMessageRequest: (requesterId)=>fetchAPI("/api/users/accept-message-request?requester_id=".concat(requesterId), {
            method: "POST"
        })
};
const messages = {
    ...
    getMessages: function(userId) {
        ...
        return fetchAPI("/api/messages/".concat(userId, "?page=").concat(page, "&limit=").concat(limit));
    },
    sendMessage: (userId, content)=>fetchAPI("/api/messages/".concat(userId), {
            method: "POST",
            body: JSON.stringify({
                content
            })
    ...
    markAsRead: async (userId)=>{
        ...
        try {
            const result = await fetchAPI("/api/messages/".concat(userId, "/read"), {
                method: "PUT"
            });
    ...
    getGroupMessages: function(groupId) {
        let page = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : 1, limit = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : 50;
        return fetchAPI("/api/groups/".concat(groupId, "/messages?page=").concat(page, "&limit=").concat(limit));
    },
    sendGroupMessage: (groupId, content)=>fetchAPI("/api/groups/".concat(groupId, "/messages"), {
            method: "POST",
            body: JSON.stringify({
                content
            })
...
const notifications = {
    getNotifications: function() {
        ...
        return fetchAPI("/api/notifications?".concat(params));
    },
    markAsRead: (notificationId)=>fetchAPI("/api/notifications/read?id=".concat(notificationId), {
            method: "PUT"
        }),
...
const activity = {
    getUserActivities: function() {
        let userID = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        const endpoint = userID ? "/api/activity/".concat(userID) : "/api/activity";
        ...
        return fetchAPI("".concat(endpoint).concat(queryString ? "?".concat(queryString) : ""));
    },
    getUserPosts: function() {
        let userID = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null, params = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
        const endpoint = userID ? "/api/activity/".concat(userID, "/posts") : "/api/activity/posts";
        const searchParams = new URLSearchParams();
        if (params.page) searchParams.append("page", params.page);
        if (params.limit) searchParams.append("limit", params.limit);
        const queryString = searchParams.toString();
    ...
    hideActivity: (activityID)=>fetchAPI("/api/activity/".concat(activityID, "/hide"), {
            method: "PUT"
        }),
    unhideActivity: (activityID)=>fetchAPI("/api/activity/".concat(activityID, "/unhide"), {
            method: "PUT"
        }),
...
const connectWebSocket = (onMessage)=>{
    ...
    const ws = new WebSocket("".concat(protocol, "//").concat(host, "/ws"));
    ws.onmessage = (event)=>{
        try {
...
function FollowButton(param) {
    let { targetUserID, onStatusChange = null, size = 'default' } = param;
    _s();
    ...
    const handleFollow = async ()=>{
        try {
            ...
            onStatusChange === null || onStatusChange === void 0 ? void 0 : onStatusChange(result.status);
        } catch (error) {
    ...
    const baseClasses = "".concat(getSizeClasses(), " rounded-lg font-medium transition-colors flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed");
    if (followStatus === 'none') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            onClick: handleFollow,
            disabled: loading,
            className: "".concat(baseClasses, " bg-primary hover:bg-primary-hover text-white"),
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$user$2d$plus$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__UserPlus$3e$__["UserPlus"], {
                    size: 16
                }, void 0, false, {
    ...
    if (followStatus === 'pending') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            disabled: loading,
            className: "".concat(baseClasses, " bg-warning hover:bg-warning-dark text-white"),
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$clock$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Clock$3e$__["Clock"], {
                    size: 16
                }, void 0, false, {
    ...
    if (followStatus === 'accepted') {
        return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
            ...
            disabled: loading,
            className: "".concat(baseClasses, " bg-surface hover:bg-border text-text-primary border border-border"),
            children: [
...
function getAvatarUrl(avatarPath) {
    ...
    if (avatarPath.startsWith('/')) {
        return "".concat(API_BASE_URL).concat(avatarPath);
    }
...
function getImageUrl(imagePath) {
    ...
    if (imagePath.startsWith('/')) {
        return "".concat(API_BASE_URL).concat(imagePath);
    }
    // Default case - assume it's a relative path
    return "".concat(API_BASE_URL, "/").concat(imagePath);
}
        ...
        try {
            ...
            for (const group of groupsArray){
                try {
                    ...
                    if ((groupDetail === null || groupDetail === void 0 ? void 0 : groupDetail.members) && Array.isArray(groupDetail.members)) {
                    ...
                    console.error("Error fetching details for group ".concat(group.id, ":"), error);
                }
            }
                    ...
                    children: [
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: onlineUsers.map((onlineUser)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                                    href: "/profile/".concat(onlineUser.id),
                                    style: {
                                        textDecoration: 'none'
                                    },
                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            onlineUser.avatar ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                src: (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$src$2f$utils$2f$image$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getImageUrl"])(onlineUser.avatar),
                                                alt: "".concat(onlineUser.first_name, " ").concat(onlineUser.last_name),
                                                style: {
                                                    ...userAvatarStyles,
                                                    objectFit: 'cover'
                                                }
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: onlineUser.nickname ? "@".concat(onlineUser.nickname) : 'Online now'
                                                    }, void 0, false, {
                                                        fileName: "[project]/frontend/src/components/layout/RightSidebar.jsx",
                                                        lineNumber: 333,
                                                        columnNumber: 23
                                                ...
                                                children: [
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                style: userMetaStyles,
                                                                children: user.nickname ? "@".concat(user.nickname) : 'New user'
                                                            }, void 0, false, {
                                                                fileName: "[project]/frontend/src/components/layout/RightSidebar.jsx",
                                                                lineNumber: 426,
                                                                columnNumber: 23
...
//# sourceMappingURL=frontend_src_5aaad9ed._.js.map