        ...
        <div className={sectionClasses}>
          ...
          <div>
            ...
            {process.env.NODE_ENV === 'development' && (
              <div style={{fontSize: '0.75rem', color: 'rgb(var(--color-text-secondary))', marginBottom: '0.5rem'}}>
            ...
            {loading ? (
              // Loading skeleton
              [...Array(3)].map((_, i) => (
                <div key={i} style={{...userItemStyles, backgroundColor: 'rgb(var(--color-background))', padding: '0.75rem'}}>
                  <div style={{...userAvatarStyles, backgroundColor: 'rgb(var(--color-border))'}}></div>
                  <div style={userInfoStyles}>
                    <div style={{height: '1rem', backgroundColor: 'rgb(var(--color-border))', borderRadius: '0.25rem', marginBottom: '0.5rem'}}></div>
                    <div style={{height: '0.75rem', backgroundColor: 'rgb(var(--color-border))', borderRadius: '0.25rem', width: '70%'}}></div>
                  </div>
                  <div style={{...followButtonStyles, backgroundColor: 'rgb(var(--color-border))'}}></div>
                </div>
              ))
            ) : suggestedUsers.length > 0 ? (
              suggestedUsers.map(user => (
                <div key={user.id} style={{...userItemStyles, backgroundColor: 'rgb(var(--color-background))', padding: '0.75rem'}}>
                    ...
                    <div style={userInfoStyles}>
                      ...
                      <div style={{display: 'flex', alignItems: 'center', gap: '0.25rem'}}>
                        {user.role && user.role !== 'user' && (
                          <span style={{fontSize: '0.625rem', padding: '0.125rem 0.375rem', backgroundColor: 'rgba(var(--color-primary), 0.1)', color: 'rgb(var(--color-primary))', borderRadius: '9999px', textTransform: 'capitalize'}}>
                            {user.role}
                          </span>
                        )}
                        <p style={userMetaStyles}>
