...
import BalanceDisplay from "../tokenomics/BalanceDisplay";
...
export default function Navbar() {
  ...
  const logoTextStyles = {
    ...
    fontWeight: 'bold',
    backgroundImage: 'linear-gradient(135deg, rgb(var(--color-primary)) 0%, rgb(var(--color-secondary)) 100%)',
    backgroundClip: 'text',
  ...
  const mobileMenuStyles = {
    backgroundColor: 'rgba(var(--color-surface), 0.9)',
    backdropFilter: 'blur(10px)',
    borderTop: '1px solid rgba(var(--color-border), 0.5)'
  };
        ...
        <div className="hidden md:flex" style={desktopNavStyles}>
          {isAuthenticated ? (
            <>
              ...
              {/* Notification Icon */}
              <Link href="/notifications" style={{ position: 'relative', color: 'rgb(var(--color-text-secondary))', textDecoration: 'none' }}>
              ...
              {/* Messages Icon */}
              <Link href="/chat" style={{ position: 'relative', color: 'rgb(var(--color-text-secondary))', textDecoration: 'none' }}>
