CREATE TABLE IF NOT EXISTS user_activities (
    ...
    activity_type VARCHAR(100) NOT NULL, -- 'post_created', 'post_liked', 'post_disliked', 'comment_created', 'comment_liked', 'comment_disliked'
    ...
    is_hidden BOOLEAN DEFAULT FALSE, -- Whether user has hidden this activity
...
CREATE TABLE IF NOT EXISTS user_activity_settings (
    ...
    show_to_followers_only BOOLEAN DEFAULT FALSE,
